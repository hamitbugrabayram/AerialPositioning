...
Example:
    Run the positioning system with a configuration file::
        ...
        $ python -m src.estimate --config config.yaml
        $ python -m src.estimate --config config.yaml --verbose
        $ python -m src.estimate --config config.yaml --eval --sample-interval 30
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    Returns:
        Parsed arguments namespace containing:
            ...
            - sample_interval: Sampling interval for evaluation
    """
...
Examples:
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="Sampling interval for evaluation (default: 30)",
    )
...
def main() -> int:
    ...
    try:
        ...
        if args.eval:
            ...
            runner.sample_interval = args.sample_interval
